...
/*   Updated: 2023/03/03 19:31:24 by cmarcu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount) {
    ...
    std::cout << "ClapTrap " << this << " takes " << amount << " points of damage." << std::endl;
...
void ClapTrap::beRepaired(unsigned int amount) {
    ...
    std::cout << "ClapTrap " << this << " is repaired by " << amount << " points " << std::endl;
